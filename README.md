...
4. **Authentication → URL Configuration**:
   - Site URL = **`https://chalkpassport.com`** (the public production app)
   ...
   - Redirect URLs:
     - `https://chalkpassport.com/auth/confirm**`
     - `https://chalkpassport.com/auth/callback**`
...
# Required on Vercel Production so verification emails open the public app:
...
2. Add the same env vars in the Vercel project. Production: `NEXT_PUBLIC_SITE_URL=https://chalkpassport.com`
3. Deploy
