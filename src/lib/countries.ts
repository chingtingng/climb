export type CountryMeta = {
  /** Official ISO 3166-1 English short name. */
  name: string;
  /** ISO 3166-1 Alpha-2 code (preferred general-purpose code). */
  code: string;
  /** Same as `code`; kept for callers that already use iso2. */
  iso2: string;
  /** ISO 3166-1 Alpha-3 code when known. */
  iso3: string;
  flag: string;
};
...
/**
 * ISO 3166-1 country and territory list: official English short names + Alpha-2 codes.
 * Source: ISO 3166 Maintenance Agency (via datasets/country-list).
 * Article suffixes like "(the)" are omitted for display; Alpha-3 remains searchable.
 */
const COUNTRIES: CountryRecord[] = [
  ...
  { name: "Bolivia (Plurinational State of)", iso2: "BO", iso3: "BOL", aliases: ["bolivia"] },
  { name: "Bonaire, Sint Eustatius and Saba", iso2: "BQ", iso3: "BES" },
  ...
  { name: "Brunei Darussalam", iso2: "BN", iso3: "BRN", aliases: ["brunei"] },
  ...
  { name: "Cocos (Keeling) Islands", iso2: "CC", iso3: "CCK" },
  { name: "Colombia", iso2: "CO", iso3: "COL" },
  { name: "Comoros", iso2: "KM", iso3: "COM" },
  { name: "Congo (the Democratic Republic of the)", iso2: "CD", iso3: "COD", aliases: ["drc", "democratic republic of the congo", "congo-kinshasa"] },
  { name: "Congo", iso2: "CG", iso3: "COG", aliases: ["congo-brazzaville", "republic of the congo"] },
  ...
  { name: "Cura\u00e7ao", iso2: "CW", iso3: "CUW" },
  { name: "Cyprus", iso2: "CY", iso3: "CYP" },
  { name: "Czechia", iso2: "CZ", iso3: "CZE", aliases: ["czech republic"] },
  { name: "C\u00f4te d'Ivoire", iso2: "CI", iso3: "CIV", aliases: ["cote d'ivoire", "ivory coast"] },
  ...
  { name: "Falkland Islands (the) [Malvinas]", iso2: "FK", iso3: "FLK" },
  ...
  { name: "Holy See", iso2: "VA", aliases: ["vatican", "vatican city"] },
  ...
  { name: "Iran (Islamic Republic of)", iso2: "IR", iso3: "IRN", aliases: ["iran", "persia"] },
  ...
  { name: "Korea (the Democratic People's Republic of)", iso2: "KP", iso3: "PRK", aliases: ["north korea", "korea, democratic people's republic of", "dprk"] },
  { name: "Korea (the Republic of)", iso2: "KR", iso3: "KOR", aliases: ["south korea", "korea", "republic of korea", "korea republic of"] },
  { name: "Kuwait", iso2: "KW", iso3: "KWT" },
  { name: "Kyrgyzstan", iso2: "KG", iso3: "KGZ" },
  { name: "Lao People's Democratic Republic", iso2: "LA", iso3: "LAO", aliases: ["laos"] },
  ...
  { name: "Macao", iso2: "MO", iso3: "MAC", aliases: ["macau", "macao"] },
  ...
  { name: "Micronesia (Federated States of)", iso2: "FM", iso3: "FSM", aliases: ["micronesia"] },
  { name: "Moldova (the Republic of)", iso2: "MD", iso3: "MDA", aliases: ["moldova"] },
  ...
  { name: "Netherlands (Kingdom of the)", iso2: "NL", iso3: "NLD", aliases: ["holland"] },
  ...
  { name: "North Macedonia", iso2: "MK", iso3: "MKD", aliases: ["macedonia", "fyrom"] },
  ...
  { name: "Palestine, State of", iso2: "PS", iso3: "PSE", aliases: ["palestine"] },
  ...
  { name: "Russian Federation", iso2: "RU", iso3: "RUS", aliases: ["russia"] },
  { name: "Rwanda", iso2: "RW", iso3: "RWA" },
  { name: "R\u00e9union", iso2: "RE", iso3: "REU" },
  { name: "Saint Barth\u00e9lemy", iso2: "BL", iso3: "BLM" },
  { name: "Saint Helena, Ascension and Tristan da Cunha", iso2: "SH", iso3: "SHN" },
  { name: "Saint Kitts and Nevis", iso2: "KN", iso3: "KNA" },
  { name: "Saint Lucia", iso2: "LC", iso3: "LCA" },
  { name: "Saint Martin (French part)", iso2: "MF", iso3: "MAF" },
  ...
  { name: "Sint Maarten (Dutch part)", iso2: "SX", iso3: "SXM" },
  ...
  { name: "Syrian Arab Republic", iso2: "SY", iso3: "SYR", aliases: ["syria"] },
  { name: "Taiwan (Province of China)", iso2: "TW", iso3: "TWN", aliases: ["taiwan", "taiwan province of china"] },
  { name: "Tajikistan", iso2: "TJ", iso3: "TJK" },
  { name: "Tanzania, the United Republic of", iso2: "TZ", iso3: "TZA", aliases: ["tanzania"] },
  ...
  { name: "T\u00fcrkiye", iso2: "TR", iso3: "TUR", aliases: ["turkey"] },
  { name: "Uganda", iso2: "UG", iso3: "UGA" },
  { name: "Ukraine", iso2: "UA", iso3: "UKR" },
  { name: "United Arab Emirates", iso2: "AE", iso3: "ARE", aliases: ["uae", "dubai"] },
  { name: "United Kingdom of Great Britain and Northern Ireland", iso2: "GB", iso3: "GBR", aliases: ["united kingdom", "uk", "britain", "england", "scotland", "wales", "great britain"] },
  { name: "United States Minor Outlying Islands", iso2: "UM", iso3: "UMI" },
  { name: "United States of America", iso2: "US", iso3: "USA", aliases: ["united states", "usa", "us", "america", "u.s.", "u.s.a."] },
  { name: "Uruguay", iso2: "UY", iso3: "URY" },
  { name: "Uzbekistan", iso2: "UZ", iso3: "UZB" },
  { name: "Vanuatu", iso2: "VU", iso3: "VUT" },
  { name: "Venezuela (Bolivarian Republic of)", iso2: "VE", iso3: "VEN", aliases: ["venezuela"] },
  { name: "Viet Nam", iso2: "VN", iso3: "VNM", aliases: ["vietnam"] },
  { name: "Virgin Islands (British)", iso2: "VG", iso3: "VGB" },
  { name: "Virgin Islands (U.S.)", iso2: "VI", iso3: "VIR" },
...
for (const country of COUNTRIES) {
  ...
  if (country.iso3) LOOKUP.set(normalize(country.iso3), country);
...
export function countryMeta(country: string): CountryMeta {
  ...
  return {
    ...
    code: letters.padEnd(2, "X"),
    iso2: letters.length === 2 ? letters : "",
    iso3: "",
    flag: letters.length === 2 ? flagFromIso2(letters) : "",
  };
}
