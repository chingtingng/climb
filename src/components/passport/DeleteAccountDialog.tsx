  ...
  return (
    <>
      <button
        ...
        className="flex h-14 w-full items-center gap-3 border-0 border-t border-sky-200 bg-transparent px-4 py-0 text-danger-ink"
      >
        <TrashIcon />
            ...
            <div className="fixed inset-0 z-[60] flex items-center justify-center p-5">
              ...
              >
                ...
                <p id={copyId} className="mt-2 text-sm leading-relaxed text-ink-soft">
                  ...
                  Places other climbers still use stay in the catalog. This cannot be
                  undone.
                </p>
                <label
                  htmlFor={fieldId}
